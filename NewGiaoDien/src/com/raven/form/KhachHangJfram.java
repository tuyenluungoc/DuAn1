 ...
 * @author admin
 */
public class KhachHangJfram extends javax.swing.JFrame {

    private DefaultTableModel dtm = new DefaultTableModel();
    private KhachHangService service = new KhachHangService();

    /**
     * Creates new form KhachHangJfram
     */
    public KhachHangJfram() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel27.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thông tin khách hàng", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 14))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KhachHangJfram.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KhachHangJfram().setVisible(true);
            }
        });
    }
