 ...
 * @author admin
 */
public class ChatLieuFrame extends javax.swing.JFrame {
private DefaultTableModel dtm = new DefaultTableModel();
private ChatLieuService service = new ChatLieuService();
    /**
     * Creates new form ChatLieuFrame
     */
    public ChatLieuFrame() {
        initComponents();
        fill();
        Show(0);
    ...
    private void initComponents() {
        ...
        jLabel27.setText("Tên chất liệu:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChatLieuFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChatLieuFrame().setVisible(true);
            }
        });
    }
    public void fill() {
        ...
        dtm.setRowCount(0);
        for (ChatLieu x : service.gettAll()) {
